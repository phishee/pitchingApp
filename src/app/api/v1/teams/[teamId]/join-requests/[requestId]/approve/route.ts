// src/app/api/v1/teams/[teamId]/join-requests/[id]/approve/route.ts
...
export async function POST(req: NextRequest, context: { params: { teamId: string; requestId: string } }) {
    ...
    return joinRequestController.approveJoinRequest(req, { params: { teamId: params.teamId, id: params.requestId } });
}