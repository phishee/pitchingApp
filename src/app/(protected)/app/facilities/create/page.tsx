...
function CreateFacilityForm() {
  ...
  const { formData, updateField, isSubmitting, setSubmitting, errors, clearErrors } = useFacilityForm();
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                Please select an organization to create a facility
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Add a new facility to {currentOrganization.name}</p>
        </div>
      </div>
